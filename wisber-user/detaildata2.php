                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <p class="p-2 bg-light border" name="nama_wisata">Wisata Bunga</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                              <label for="exampleFormControlInput1" class="form-label"><strong>Alamat</strong></label>
                              <p class="p-2 bg-light border" name="alamat">Jl Jawa</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <p class="p-2 bg-light border" name="kategori">Belanja</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"><strong>Penanggung Jawab</strong></label>
                                <p class="p-2 bg-light border" name="penanggung_jawab">Suyitno</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <p class="p-2 bg-light border">10000</p>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <p class="p-2 bg-light border">5000</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"><strong>Dewasa</strong></label>
                                <p class="p-2 bg-light border">20000</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
