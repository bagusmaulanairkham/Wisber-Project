  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="card recent-sales overflow-auto">
        <div class="card-body">
          <h5 class="card-title">Data Request Potensi Wisata</h5>
          <a href="formwisata.php"><button type="button" class="btn btn-primary position-absolute top-0 end-0 m-3"><span>Tambah Data</span></button></a>
          <table class="table table-striped table-bordered datatable">
            ...
            <tbody>
              <tr>
                <td class="text-center">Wisata 1</th>
                <td class="text-center">Alam</td>
                <td class="text-center">Jl Sumatra</td>
                <td class="text-center text-warning small pt-1 fw-bold">
                  Menunggu
                </td>
                <td class="text-center">
                  <a href="detaildata2.php"><i class="bi bi-eye"></i></a>
                  <a href="formubahwisata.php"><i class="bi bi-pencil-square "></i></a>
                </td>
              </tr>
            </tbody>
          </table>
