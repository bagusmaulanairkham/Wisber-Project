    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              <h5 class="card-title">Total Wisata Terdaftar </h5>
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="nav-item dropdown">
                  <button class="btn btn-primary" data-bs-toggle="dropdown">Notifikasi <span class="badge bg-primary badge-number">4</span></button>
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">List Wisata di Kecamatan Jember</h5>
              <!-- Line Chart -->
